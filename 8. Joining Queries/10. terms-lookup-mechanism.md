...
Reminder: Terms is  equivalent to  IN clause in SQL dbs
so lookup  mechanism allows to dynamicly define searched array of values
```json
"terms": {
  "user": { 
    "index": "users",
...
```
MEANS GO to index user. Get doc with id = 1. And get value of 'following'
