...
- should be formated according to the ISO 8601 format

Stored in millis even if supplied string
Dates are to the UTC tz
same date conversion will be performed for search queries
